...
{
	get_infos_t infos = {"pcf/sounds.pcf", INIT_INDICATOR,
	&init_audio_lib_from_pcf};
...
{
	get_infos_t infos = {"pcf/textures.pcf", INIT_INDICATOR,
...
{
	get_infos_t infos = {"pcf/fonts.pcf", INIT_INDICATOR,
